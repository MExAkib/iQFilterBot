...
API_ID = int(environ.get('API_ID', '21377679'))
API_HASH = environ.get('API_HASH', '359ed998392d773cc1e0cefb3ca697d6')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6642047024').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002062126996').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://iqfilterbot:iqfilterbot@cluster0.vaddrmj.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "iqfilterbot")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/Korean_Drama_In_Hindi_Dubbed_4u')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Korean_Drama_In_Hindi_Dubbed_4u')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Hello, My Dear Friends!❤️')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001942280542'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Korean_Drama_In_Hindi_Dubbed_4u')
...
URL = "https://iq-filter-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://iq-filter-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://iq-filter-bot.onrender.com/".format(FQDN)
else:
    URL = "https://iq-filter-bot.onrender.com/".format(FQDN)
